...
void appl_form::on_actionTile_with_system_function_triggered()
{
	...
	ws->setActivationOrder(QMdiArea::CreationOrder);  // does not work as expected
...
void appl_form::on_actionMake_tar_file_with_calibrations_and_lookup_tables_triggered()
{
	...
	{
		case 0:   // Yes
			string command_line = "cd " + path.spy_dir + "\n "
					// + "pwd \n"
...
void appl_form::on_actionCustom_tiling_triggered()
{
	...
	double vertical_distance = 1.0 *(ws->height() - 2) / pion;
	double horizontal_distance = 1.0* (ws->width() - 2) / poziom;
