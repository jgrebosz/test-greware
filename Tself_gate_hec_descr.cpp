...
void Tself_gate_hec_descr::read_definition_from(string pathed_name)
{
    ...
    // path.user_def_spectra + name_of_spectrum + ".self_gate_hec_cristal" ;
    ...
    try
    {
        ...
        //    unsigned int i = name.find( ".self_gate_hec_cristal"); // != string::npos)
        //    if(i == string::npos)
        //    {
        //      name += ".self_gate_hec_cristal" ;
        //    }
...
void Tself_gate_hec_descr::write_definitions(string path_only)
{
    ...
    //  if(file_name.find(".self_gate_hec_cristal") == string::npos)
    //  {
    //    file_name += ".self_gate_hec_cristal" ;
    //  }
